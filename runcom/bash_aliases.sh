...
alias shib-dh1='open -na "Google Chrome" --args --user-data-dir=$HOME/.chromep/dh1 --proxy-server=socks5://dh1:28081 https://192.168.0.31:4200/webuser/'
alias shib-spt='open -na "Google Chrome" --args --user-data-dir=$HOME/.chromep/spt --proxy-server=socks5://support:28081 https://support:4200/webuser/'
alias shib-haj='open -na "Google Chrome" --args --user-data-dir=$HOME/.chromep/haj --proxy-server=socks5://hajime:28081 https://hajime:4200/webuser/'
...
alias asS3='s3cmd ls s3://files.atscale.com/installer/package/ | grep -E "^201[89]-.+atscale-[56789].+\.x86_64\.(tar\.gz|rpm)$"'

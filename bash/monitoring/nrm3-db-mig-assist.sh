...
# Oneliner command:
    bash <(curl -sSfL https://raw.githubusercontent.com/sonatype/nexus-monitoring/main/scripts/nrm3-db-mig-assist.sh --compressed)
# Or, to specify DB Migrator version with '-m':
    curl -O -sSfL https://raw.githubusercontent.com/sonatype/nexus-monitoring/main/scripts/nrm3-db-mig-assist.sh --compressed

...
chrome.webRequest.onBeforeRequest.addListener(replaceUrl, {
    ...
    urls: ['https://*.visual.force.com/*', 'https://customers.atscale.com/*'], //'https://*.salesforce.com/console*'
    types: ["main_frame"]
});
...
function replaceUrl(details) {
    ...
    var caseId_regex = new RegExp("^https://(.+\.visual\.force\.com/apex/Case_Lightning.*[?&]id=|customers\.atscale\.com/s/case/)(50[^\?&/]+)");
    ...
    chrome.tabs.get(details.tabId, function (tab) {
        ...
        if (match && match.length > 1) {
            var new_url = "https://na63.salesforce.com/" + match[2];

...
func TestListObjects_ValidBaseDir_ReturnsFileCount(t *testing.T) {
	...
	client := &FileClient{}
	db := &sql.DB{}
	count := client.ListObjects(baseDir, "", db, func(path interface{}, info interface{}, db *sql.DB) {})
...
func TestListObjects_FilteredFiles_ReturnsFilteredCount(t *testing.T) {
	...
	client := &FileClient{}
	db := &sql.DB{}
	count := client.ListObjects(baseDir, ".txt", db, func(path interface{}, info interface{}, db *sql.DB) {})
...
func TestListObjects_TopNLimit_ReturnsLimitedCount(t *testing.T) {
	...
	db := &sql.DB{}
	common.PrintedNum = 0
	testFunc := func(path interface{}, info interface{}, db *sql.DB) {
		common.PrintedNum++
	}
...
func TestListObjects_InvalidBaseDir_ReturnsError(t *testing.T) {
	...
	client.ListObjects(baseDir, "", db, func(path interface{}, info interface{}, db *sql.DB) {})
}
